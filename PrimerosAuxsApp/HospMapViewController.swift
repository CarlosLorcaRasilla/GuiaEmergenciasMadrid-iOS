...
class HospMapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {

    @IBOutlet weak var background: UIImageView!
    @IBOutlet weak var HospMap: MKMapView!
    
    var matchingItems: [MKMapItem] = [MKMapItem]()
    
    let manager = CLLocationManager()
    
    //var resultadoBusqueda: UISearchController? = nil
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        HospMap.setRegion(region, animated: false)
        
        self.HospMap.showsUserLocation = true
    ...
    func performSearch() {
        ...
        search.start(completionHandler: {(response, error) in
            ...
            if error != nil {
                ...
                print("No se han encontrado Hospitales cerca de tu ubicación")
            } else {
                print("Se han encontrado Hospitales cerca")
                ...
                for item in response!.mapItems {
                    ...
                    self.HospMap.addAnnotation(annotation)
                }
            }
        })
    }
